...
(() => {
/*!*************************************!*\
  !*** ./resources/js/punch_begin.js ***!
  \*************************************/
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
// 要素を取得
var punch_confirm_enter = document.getElementById('punch_confirm_enter');
var early_work_select_info_id = document.getElementById('early_work_select_info');
var message = document.getElementById('message'); // 出勤打刻タイプが押下されたら

$("[id=punch_begin_type]").on("click", function () {
  // 要素を取得
  var punch_begin_type = document.getElementById('punch_begin_type');
  var punch_begin_type_label = document.getElementById('punch_begin_type_label'); // checkboxがtrueなら「早出」、falseなら「通常」に書き換える

  punch_begin_type_label.innerHTML = punch_begin_type.checked ? '早出' : '通常'; // 早出状態の時の処理
  ...
  if (punch_begin_type.checked) {
    ...
    for (var i = 0; i < early_work_select_info_name.length; i++) {
      var element = document.getElementById(early_work_select_info_name[i].id);
      var element_label = document.getElementById(early_work_select_info_name[i].id + '_label');
