...
(() => {
/*!********************************************!*\
  !*** ./resources/js/punch_finish_input.js ***!
  \********************************************/
...
var input_time_left_modal = document.getElementById('input_time_left_modal'); // 荷主稼働時間入力モーダルを開く
...
$("[class^=working_time_input_modal_open]").on("click", function () {
  ...
  input_customer_name.innerHTML = this.innerHTML; // 稼働時間の数値を初期化

  input_working_time.innerHTML = '0.00'; // 残り入力時間を更新
...
$("[id=working_time_input_enter]").on("click", function () {
  try {
    ...
    working_time_input.innerHTML = input_customer_name.innerHTML + "<br>" + input_working_time.innerHTML; // 送信する要素を作成して表示
    ...
    input_working_time_info.append(working_time_input, working_time_hidden); // 残り入力時間を更新

    input_time_left.innerHTML = (Number(input_time_left.innerHTML) - Number(input_working_time.innerHTML)).toFixed(2); // モーダルを閉じる
...
$(document).on("click", ".working_time_info_delete", function () {
  ...
  var delete_target_2 = document.getElementById(this.id + '_hidden'); // 残り入力時間を更新

  input_time_left.innerHTML = (Number(input_time_left.innerHTML) + Number(delete_target_2.value)).toFixed(2); // 要素を削除
