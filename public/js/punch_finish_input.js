...
var input_working_time_info = document.getElementById('input_working_time_info'); // 荷主稼働時間入力モーダルを開く
...
$("[id=working_time_input_enter]").on("click", function () {
  ...
  working_time_input.innerHTML = input_customer_name.innerHTML + ' / ' + input_working_time.innerHTML; // 送信する要素を作成して表示
  ...
  input_working_time_info.append(working_time_input, working_time_hidden); // モーダルを閉じる
