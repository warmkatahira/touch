<x-app-layout>
    <div class="py-5 mx-5">
        ...
        <div class="grid grid-cols-12">
            <form method="GET" action="{{ route('kintai_modify.input') }}" class="m-0 col-span-12 grid grid-cols-12">
                <label for="begin_time" class="col-span-1 bg-black text-white text-center text-sm py-2">出勤時間</label>
                <input type="time" id="begin_time" name="begin_time" class="col-span-1 text-sm" autocomplete="off" value="{{ old('begin_time', $kintai->begin_time) }}">
                <label for="finish_time" class="col-span-1 bg-black text-white text-center text-sm py-2">退勤時間</label>
                <input type="time" id="finish_time" name="finish_time" class="col-span-1 text-sm" autocomplete="off" value="{{ old('finish_time', $kintai->finish_time) }}">
