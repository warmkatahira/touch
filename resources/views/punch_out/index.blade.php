...
<x-app-layout>
    ...
    <div class="py-5 mx-5">
        <div class="grid grid-cols-12 gap-4">
            ...
            <p class="col-start-2 col-span-2 text-center text-4xl bg-emerald-100 border-b-4 border-emerald-400 rounded-t-lg py-2 h-3/4">外出</p>
            <x-clock/>
        </div>
    ...
    <!-- 打刻確認モーダル -->
    <x-punch-confirm-modal-1 proc="外出"/>
</x-app-layout>
