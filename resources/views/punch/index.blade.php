...
<x-app-layout>
    ...
    <div class="py-5 mx-5">
        <div class="grid grid-cols-12 gap-x-4 gap-y-20">
            ...
            <a href="{{ route('today_kintai.index') }}" class="col-span-3 h-40 bg-black text-white text-5xl 2xl:text-6xl text-center font-semibold rounded-lg shadow-lg py-12">今日の勤怠</a>
