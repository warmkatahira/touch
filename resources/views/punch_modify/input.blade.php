                    ...
                    <div class="col-start-1 col-span-12 border-2 border-blue-500">
                        <div class="p-5 grid grid-cols-12 gap-4">
                            @foreach($add_rest_times as $add_rest_time)
                                <div class="col-span-2">
                                    <input type="radio" name="add_rest_time" id="{{ $add_rest_time['minute'].'_add_rest_time' }}" value="{{ $add_rest_time['minute'] }}" class="add_rest_time_select hidden" {{ $kintai->add_rest_time == $add_rest_time['minute'] ? 'checked' : '' }}>
