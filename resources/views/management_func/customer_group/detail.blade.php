...
<x-app-layout>
    <div class="py-5 mx-5">
        ...
        <div class="grid grid-cols-12 mt-5">
            ...
            <form method="POST" action="{{ route('customer_group.modify_group') }}" class="m-0 col-span-12 grid grid-cols-12">
                @csrf
            ...
            <form method="POST" action="{{ route('customer_group.update_customer_group_id') }}" class="m-0 col-span-4 grid grid-cols-12">
                @csrf
                    ...
                    @foreach($customer_groups as $customer_group)
                        <tr class="hover:bg-teal-100">
                            ...
                            <td class="p-2 border text-center">
                                <a href="{{ route('customer_group.delete_customer_group_id', ['customer_id' => $customer_group->customer_id]) }}" id="{{ $customer_group->customer_name }}" class="delete">
