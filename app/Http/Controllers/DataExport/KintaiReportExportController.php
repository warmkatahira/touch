...
class KintaiReportExportController extends Controller
{
    ...
    public function Export(Request $request)
    {
        ...
        // 出力する勤怠情報を取得
        $kintais = $KintaiReportExportService->getExportKintaiNormal($month_date['month_date'], $employees, $start_end_of_month['start_of_month'], $start_end_of_month['end_of_month']);
        // 出力対象の営業所情報を取得
        ...
        // PDF出力ビューに情報を渡す
        $pdf = $KintaiReportExportService->passExportInfo($kintais, $request->month, $base);
